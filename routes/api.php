...
Route::group(['middleware' => 'cors'], function() {
    Route::middleware('apimid:school_admin,admin_finance,admin_muhafidz_muhafidzah,admin_musyrif_musyrifah,admin_discipline')->post('list-student', 'Api\StudentController@list');
